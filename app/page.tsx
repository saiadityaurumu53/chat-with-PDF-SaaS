...
const features = [
  ...
  },
  {
    ...
    description: "Our intelligent chatbot remembers previous interactions, providing seemless and personalized experience.",
    icon: BrainCogIcon
  },
  {
  ...
  {
    name : "Cloud Backup",
    description : "Rest assured knowing your documents are safely backed up on the cloud, protected from the loss or damage",
    icon : ServerCogIcon
  },
  {
    name: "Responsive Accross devices",
    description : "Access and chat with your PDFs seemlessly on any device, weather it's your desktop, tablet, or smartphone",
          ...
          <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl sm:text-center">
                  ...
                  <p className="mt-6 text-lg leading-8 text-gray-600">
                    ...
                    questions, summarize content, and answer all your Qs. Ideally for 
